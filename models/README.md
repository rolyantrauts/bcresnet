# Example pretrained example models


Main-100
```
python main.py --data_root ../gkws/data2 --n_mels 80 --clip_duration=1.4 --lr=0.002 --epochs=100 --patience=10 --batch_size=512 --tau=2                         
