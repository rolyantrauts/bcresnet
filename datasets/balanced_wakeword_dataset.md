...
Vectorization	Wav2Vec 2.0 (HuggingFace)	Best for Speech/Adversarial. It maps audio to phonetic space, so "Jarvis" and "Harvest" appear close together.
Categorization	YAMNet or VGGish	Best for Noise/Silence. Distinguishes "Silence" from "Fan Noise" or "Traffic".
Visualization	UMAP	Best for Dimensionality Reduction. Projects high-dimensional vectors (e.g., 768-d) into 2D points you can see.
