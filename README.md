...
Log Mel vs MFCC  
Log Mel with 40/80 frequency bins obviously produce bigger input dimension for each time frame, with the reduction of 40 bin Log Mel to 13 bin MFCC being approximately 67% reduction in estimated parameter count.
...
likely on compute constrained microcontroller wakeword MFCC is likely a preffered frontend. See https://github.com/espressif/esp-dl/tree/master/esp-dl/audio  
